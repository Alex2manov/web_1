  ...
  <div class="container">
    ...
    <form action="" method="POST">
      ...
      <div class="form-group">
        <input type="date" id="data" size="3" name="data" <?php if ($errors['data']) {print 'class="group error"';} else print 'class="group"';?> value="<?php print htmlspecialchars($values['data']); ?>">
      </div>
      ...
      <br>
      Биография:<br><textarea class="group" name="biography" rows="3" cols="30"><?php print htmlspecialchars($values['biography']); ?></textarea>
